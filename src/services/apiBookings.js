...
export async function getBookings({ filter, sortByValue, page }) {
  let query = supabase
    .from('bookings')
    .select(
  ...
  if (sortByValue)
    query = query.order(sortByValue.field, {
      ascending: sortByValue.direction === 'asc',
    });
...
export async function getStaysTodayActivity() {
  ...
  console.log('activty today: ', data);
  return data;
}
